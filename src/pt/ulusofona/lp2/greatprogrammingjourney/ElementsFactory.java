...
public class ElementsFactory {
    public static BoardElement createAbyss(int id, int position) {
        switch (id) {
            ...
            case 1: return new AbyssErroDeLogica(position);
            ...
            case 6: return new AbyssEfeitosSecundarios(position);
    ...
    public static BoardElement createTool(int id, int position) {
        switch (id) {
            ...
            case 1: return new ToolProgramacaoFuncional(position);
            case 2: return new ToolUnitTests(position);
            case 3: return new ToolTratamentoDeExcepcoes(position);
